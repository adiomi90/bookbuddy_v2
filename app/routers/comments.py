...
from app.schemas.comment import CommentCreate, CommentResponse, CommentUpdate, CommentResponseWithoutReplies
...
@router.post("/", response_model=CommentResponseWithoutReplies, status_code=status.HTTP_201_CREATED)
...
async def get_all_comments_on_post(post_id: int, skip: int = 0, limit: int = 100,
    ...
    return await comment_service.get_comments_with_relations(db, post_id, skip, limit)
